...
app.use(cors({origin: 'http://asc.burno.tech'}));
...
app.use('/privacy', serve('./public/media/privacy.pdf', true));
...
app.post('/send-form-order', function (req, res) {
    ...
    let mailOptions = {
        from: 'Academy Sport Camp <siteinformingservice@gmail.com>',
        to: 'caspanch@gmail.com',
        subject: 'Academy Sport Camp',
        html: '<p>Заявка с сайта AcademySportCamp</p><p>Откуда: ' + req.body.target + '</p><p>Имя: ' + req.body.name +
            '</p><p>Телефон: ' + req.body.phone + '</p>' + '<p>Ip: '+ ip +'</p>'
    };
...
app.post('/send-form-full', function (req, res) {
    let ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
    let geo = geoIp.lookup(ip);
    ...
    let mailOptions = {
        ...
        to: 'caspanch@gmail.com',
        subject: 'Academy Sport Camp',
        html: `<p>Заявка с сайта AcademySportCamp</p>
        <p>Количество людей: ${req.body.people}</p>
        <p>Дата заезда: ${req.body.dates.start}</p>
        <p>Дата выезда: ${req.body.dates.end}</p>
        <p>План питания: ${req.body.food}</p>
        <p>Программа: ${req.body.program}</p>
        <p>Метод связи: ${req.body.recall}</p>
